        ...
        <div id="kt_help" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="help"
            ...
            <div class="card shadow-none rounded-0 w-100">
                ...
                <div class="card-header" id="kt_help_header">
                    <h5 class="card-title fw-semibold text-gray-600">Support</h5>
                ...
                <div class="card-body" id="kt_help_body">
                    ...
                    <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
                        ...
                        <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                            ...
                            <h4 class="fw-bold mb-5">Contact us support@oucheshosting.com</h4>


                            <h4 class="fw-bold mb-5">Contact us +234 903 499 6898</h4>
